...
function StatPill({ emoji, label, value, delay }: {
      ...
      <div style={bgStyle}>
        ...
        <motion.button
          ...
          style={{
            ...
            height: 44,
            borderRadius: '50%',
            border: isDark ? '1px solid rgba(150,135,245,0.25)' : '1px solid rgba(150,135,245,0.15)',
            background: isDark ? 'rgba(26, 24, 50, 0.8)' : 'rgba(255,255,255,0.8)',
            backdropFilter: 'blur(8px)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            cursor: 'pointer',
            boxShadow: '0 2px 12px rgba(150,135,245,0.1)',
          }}
          aria-label="Toggle theme"
        >
          {isDark ? (
            <Sun size={20} style={{ color: '#B8AEFA' }} />
          ) : (
            <Moon size={20} style={{ color: '#9687F5' }} />
          )}
        </motion.button>
        ...
        >
          ...
          <p style={{
            ...
            <Link href="/terms" style={{ color: C.crocus, textDecoration: 'underline', textUnderlineOffset: 3 }}>
              Terms
            </Link>{' '}
            &{' '}
            <Link href="/privacy" style={{ color: C.crocus, textDecoration: 'underline', textUnderlineOffset: 3 }}>
              Privacy Policy
            </Link>.
